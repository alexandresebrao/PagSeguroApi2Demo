...
def checkout(request):
    ...
    #           'email': 'comprador@uol.com.br', 'cpf': '22111944785'}
    # api.set_sender(**sender)
    # shipping = {'street': "Av. Brigadeiro Faria Lima", 'number': 1384,
    #             'complement': '5o andar', 'district': 'Jardim Paulistano',
    #             'postal_code': '01452002', 'city': 'Sao Paulo', 'state': 'SP',
    #             'country': 'BRA'}
    # api.set_shipping(**shipping)
    # item1 = PagSeguroItem(id='0001', description='Notebook Prata',
    #                       amount='24300.00', quantity=1)
    ...
    context = {'session_id' : 'Valor: ' + request.POST['sender_hash']}
    template = 'index.html'
    return render(request, template, context)
